...
@protocol CustomPickerAgent <NSObject>
...
@end
@interface CustomPickerDelegate : NSObject<UIPickerViewDelegate,UIPickerViewDataSource>

@property (nonatomic,weak) id<CustomPickerAgent> delegte;
